        ...
        <section className="section__hero">
         ...
         <div className="section__hero__innercontainer--bottom">
            <InfiniteSlider className="hero__innercontainer__bottom__slider" SliderItems={[
                <HeroSliderItem key="0" imgUrl='Asset__PortafolioImg--2.png' pageUrl='dupont-garage-app' index='0' />,
                <HeroSliderItem key="1" imgUrl='Asset__PortafolioImg--7.png' pageUrl='cybersecurity-app' index='1' />,
                <HeroSliderItem key="2" imgUrl='Asset__PortafolioImg--3.png' pageUrl='medpass-website' index='2' />,
                <HeroSliderItem key="3" imgUrl='Asset__PortafolioImg--4.png' pageUrl='podcast-website' index='3' />
            ]} />
         </div>
            </div>
